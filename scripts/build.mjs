...
import './build-guitar.mjs';
import {mkdir,copyFile,cp,rm} from 'node:fs/promises';
await rm('dist',{recursive:true,force:true});
await mkdir('dist',{recursive:true});
for(const file of ['index.html','styles.css','motion.css','app.js','motion.js','guitar.js','guitar.css','music.json','favicon.svg','robots.txt','sitemap.xml','.nojekyll']) await copyFile(file,`dist/${file}`);
